...
class CreateTblProduct extends Migration
{
    ...
    public function up()
    {
        Schema::create('Product', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('cpu_speed_id')->nullable();
            $table->unsignedBigInteger('core_id')->nullable();
            $table->unsignedBigInteger('socket_id')->nullable();
            $table->unsignedBigInteger('size_form_id')->nullable();
            $table->unsignedBigInteger('memory_size_id')->nullable();
            $table->unsignedBigInteger('memory_type_id')->nullable();
            $table->unsignedBigInteger('bus_id')->nullable();
            $table->unsignedBigInteger('color_id')->nullable();
            $table->unsignedBigInteger('fan_qty_id')->nullable();
            $table->unsignedBigInteger('storage_type_id')->nullable();
            $table->unsignedBigInteger('storage_capacity_id')->nullable();
            $table->unsignedBigInteger('storage_speed_id')->nullable();
            $table->unsignedBigInteger('cpu_id')->nullable();
            $table->unsignedBigInteger('memory_card_id')->nullable();
            $table->unsignedBigInteger('video_output_id')->nullable();
            $table->unsignedBigInteger('power_id')->nullable();
            $table->unsignedBigInteger('efficiency_id')->nullable();
            $table->unsignedBigInteger('fan_size_id')->nullable();
            $table->unsignedBigInteger('key_qty_id')->nullable();
            $table->unsignedBigInteger('wireless_id')->nullable();
            $table->unsignedBigInteger('switch_id')->nullable();
            $table->unsignedBigInteger('dpi_id')->nullable();
            $table->unsignedBigInteger('headphone_type_id')->nullable();
            $table->unsignedBigInteger('micro_id')->nullable();
            $table->unsignedBigInteger('resolution_id')->nullable();
            $table->unsignedBigInteger('moniter_size_id')->nullable();
            ...
            $table->foreign('memory_size_id')->references('id')->on('Memory_size')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->foreign('storage_speed_id')->references('id')->on('Storage_speed')->onUpdate('cascade')->onDelete('cascade');
