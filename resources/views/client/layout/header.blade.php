                        ...
                        <div class="cart-toggle hidden-xs hidden-sm">
                            <div class="cart-overflow">
                                <div class="cart-entry clearfix">
                                    <a class="cart-entry-thumbnail" href="#"><img src="{{asset ('img/product-1.png')}}" alt="" /></a>
                                ...
                                <div class="cart-entry clearfix">
                                    <a class="cart-entry-thumbnail" href="#"><img src="{{asset ('img/product-2.png')}}" alt="" /></a>
                                    <div class="cart-entry-description">
                                        <table>
                                            <tr>
                                                <td>
                                ...
                                <div class="cart-entry clearfix">
                                    <a class="cart-entry-thumbnail" href="#"><img src="{{asset ('img/product-3.png')}}" alt="" /></a>
                                    <div class="cart-entry-description">
                                        <table>
                                            <tr>
                                                <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 text-right">
                                    <a class="button size-2 style-3" href="checkout1.blade.php">
        ...
        <div class="content-margins">
            <div class="row">
                <div class="col-xs-3 col-sm-1">
                    <a id="logo" href="{{ route('client.index1')}}"><img src="{{asset ('img/logo-2.png')}}" alt="" /></a>  
                </div>
                <div class="col-xs-9 col-sm-11 text-right">
                    <div class="nav-wrapper">
                        ...
                        <nav>
                            <ul>
                                <li class="active">
                                    <a href="{{ route('client.index1')}}">Home</a>
                                </li>
                                <li>
                                    <a href="{{ route('client.about1')}}">about us</a>
                                </li>
                                <li class="megamenu-wrapper">
                                    <a href="{{ route('client.products1')}}">products</a>
                                    <div class="menu-toggle"></div>
                                    <div class="megamenu">
                                        <div class="links">
                                            <a class="active" href="{{ route('client.products1')}}">Products Landing 1</a>
                                            <a href="{{ route('client.products2')}}">Products Landing 2</a>
                                            <a href="{{ route('client.products3')}}">Products Landing 3</a>
                                            <a href="{{ route('client.product')}}">Product Detail</a>
                                        </div>
                                        <div class="content">
                                                    ...
                                                    <div class="product-shortcode style-5">
                                                            ...
                                                            <div class="swiper-container" data-loop="1">
                                                                ...
                                                                <div class="swiper-wrapper">
                                                                    <div class="swiper-slide">
                                                                        <img src="{{asset ('img/product-59.jpg')}}" alt="" />
                                                                    </div>
                                                                    <div class="swiper-slide">
                                                                        <img src="{{asset ('img/product-61.jpg')}}" alt="" />
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        <div class="content-animate">
                                                            <div class="title">
                                                                ...
                                                                <div class="h6 animate-to-green"><a href="product.blade.php">modern beat nine</a></div>
                                                            </div>
                                                        ...
                                                        <div class="preview-buttons">
                                                            <div class="buttons-wrapper">
                                                                <a class="button size-2 style-2" href="product.blade.php">
                                                                    <span class="button-wrapper">
                                                    ...
                                                    <div class="product-shortcode style-5">
                                                        ...
                                                        <div class="preview">
                                                            <div class="swiper-container" data-loop="1">
                                                                ...
                                                                <div class="swiper-wrapper">
                                                                    <div class="swiper-slide">
                                                                        <img src="{{asset ('img/product-60.jpg')}}" alt="" />
                                                                    </div>
                                                                    <div class="swiper-slide">
                                                                        <img src="{{asset ('img/product-61.jpg')}}" alt="" />
                                                                    </div>
                                ...
                                <li>
                                    <a href="{{ route('client.services1')}}">Services</a>
                                </li>
                                <li>
                                    <a href="{{ route('client.gallery1')}}">gallery</a>
                                </li>
                                <li class="megamenu-wrapper">
                                    <a href="#">Pages</a>
                                    <div class="menu-toggle"></div>
                                    <div class="megamenu">
                                        <div class="links">
                                            <a class="active" href="{{ route('client.checkout1')}}">Checkout 1</a>
                                            <a href="{{ route('client.cart')}}">Cart</a>
                                            <a href="{{ route('client.elements')}}p">Elements</a>
                                        </div>
                                        <div class="content">
                                            <div class="row nopadding">
                                                <div class="col-xs-6">
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="banner-shortcode style-3 rounded-image text-center" style="background-image: url({{asset ('img/background-11.jpg')}});">
