    ...
    <form action="{{URL::to('admin/save_product')}}" method="post" enctype="multipart/form-data">
        ...
        <ul>
            <li> <div class="form-group">
                Keys
                <select name="key_qty" class="form-control"style="width:200px">
                    <option value="">-----Choose-----</option>
                    @foreach($key_qty as $key=>$keys)
                    <option value="{{$keys->id}}"> {{$keys->key_qty}}</option>
                    @endforeach
                </select>
            </div></li>
            <li> <div class="form-group">
            ...
            <li> <div class="form-group">
                Swtich
                <select name="switch" class="form-control"style="width:200px">
                    <option value="">-----Choose-----</option>
                    @foreach($switch as $key=>$swi)
                    <option value="{{$swi->id}}"> {{$swi->switch_name}}</option>
                    @endforeach
                </select>
            </div></li>
            <li> <div class="form-group">
