...
<div style="margin-top:20px;font-weight:bold">PRODUCT / CREATE / CASE</div>
<h2 class="text-center">CREATE NEW PRODUCT (CASE)</h1>
    <div class="dropdown">
        ...
        <ul>
            <li> <div class="form-group">
                ...
                <select name="size_form" class="form-control"style="width:200px">
                    <option value="">-----Choose-----</option>
                    @foreach($size_form as $key=>$size)
                    <option value="{{$size->id}}"> {{$size->size_form_name}}</option>
                    @endforeach
                </select>
            </div></li>
            <li> <div class="form-group">
                Fan
                <select name="fan" class="form-control"style="width:200px">
                    <option value="">-----Choose-----</option>
                    @foreach($fan_qty as $key=>$fan)
                    <option value="{{$fan->id}}"> {{$fan->fan_qty}}</option>
                    @endforeach
                </select>
            </div></li>
            <li> <div class="form-group">
